...
const Destination = () => {
  ...
  return (
    <div className=" container destination-style">
      ...
      <div className="row">
        <div className=" col-sm-12  col-lg-3 mt-5 card-style">
          <h4 style={{ color: "#7E67EA", textAlign: "center" }}>
            {locationFrm} <FontAwesomeIcon icon={faBiking} /> {locationTo}
          </h4>
          <div className="div-style">
            <img src={photo} alt="" />
            <p style={{ color: "#8000ff", fontWeight: "600" }}>
              Seat Range: <FontAwesomeIcon icon={faUsers} /> {seat}
            </p>
